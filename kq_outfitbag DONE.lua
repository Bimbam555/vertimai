...
Locale = {
    ...
    ['Pickup the bag'] = 'Paimti krepšį',
    ['Make public'] = 'Leisti naudotis visiems',
    ...
    ['~w~Press [~g~{PUBLIC_KEYBIND}~w~] to open make the bag ~g~public'] = '~w~Paspauskite [~g~{PUBLIC_KEYBIND}~w~], kad atidarytumėte krepšį ~g~matomą visiems',
