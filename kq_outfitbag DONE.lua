Locale = {
    ...
    ['Make public'] = 'Padaryti visiems matomą',
    ...
    ['~w~Press [~g~{PUBLIC_KEYBIND}~w~] to open make the bag ~g~public'] = '~w~Paspauskite [~g~{PUBLIC_KEYBIND}~w~], kad atidarytumėte krepšį ~g~visiems matomą',
